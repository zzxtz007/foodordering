...
public class ConsumerController {
	...
	public String updateById(String name, String studentId, String phone) throws Throwable {
		return GSON.toJson(consumerService.updateById("软件注册", name, studentId, phone));
	}
