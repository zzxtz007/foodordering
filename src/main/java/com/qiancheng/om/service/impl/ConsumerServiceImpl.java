...
public class ConsumerServiceImpl implements ConsumerService {
    ...
    @Override
    public Response updateById(String uid, String name, String studentId) throws Throwable {
        int rows;
        if (uid == null || name == null || studentId == null || name.equals("") || studentId
                .equals("")) {
        ...
        try {
            ...
            rows = consumerMapper.updateById(consumer);
            if (!(rows > 0)) {
                LOGGER.debug("方法结束，状态码为3");
                return new Response(3);
            }
            ...
            for (Map map : orderList) {
                ...
                for (Map orderFoodMap : orderFoodList) {
                    ...
                    if (foods.get(foodId) == null) {
                        ...
                        foods.put(orderFoodMap.get("foodId") + "", foods.get(foodId) + Integer.parseInt(orderFoodMap.get("count") + ""));
                    }
                }
            }
